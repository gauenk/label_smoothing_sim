...
class TestResultsCache(TwoLevelCache):
    ...
    def construct_data_cache_config(self,cfg,imdb_config):
        ...
        testCacheConfig.model_info = cfg.model_info
        print(testCacheConfig.model_info)
        testCacheConfig.transform_each_sample = cfg.DATASETS.TRANSFORM_EACH_SAMPLE
        # we don't want to save the actual config within the model_info
        testCacheConfig.model_info.additional_input.info['activations'].cfg = None
